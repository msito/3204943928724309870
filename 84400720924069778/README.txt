index.html is written by Shino Ito.
...
For the purpose of demonstration, all the files are in one file.  

In right environment, JQuery components should be stored in js file and CSS should be stored in css file.

Ideally, jquery library should be stored localy.
